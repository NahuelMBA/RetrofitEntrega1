...
import com.example.retrofit_entrega1.databinding.FragmentInquilinosBinding;
...
public class InquilinosFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        binding.rvAlquilados.setLayoutManager(new LinearLayoutManager(getContext()));
        ...
        viewModel.getAlquilados().observe(getViewLifecycleOwner(), listaAlquilados -> {
            ...
            binding.rvAlquilados.setAdapter(adapter);
        });
